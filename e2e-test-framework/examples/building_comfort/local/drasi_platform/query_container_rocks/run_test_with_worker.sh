...
drasi apply -f examples/building_comfort/drasi/query_container_rocks/query_rocks_worker.yaml
drasi wait -f examples/building_comfort/drasi/query_container_rocks/query_rocks_worker.yaml -t 200
