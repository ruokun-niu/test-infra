...
drasi apply -f examples/building_comfort/drasi/query_container_redis/query_redis_worker.yaml
drasi wait -f examples/building_comfort/drasi/query_container_redis/query_redis_worker.yaml -t 200
