...
drasi apply -f examples/building_comfort/drasi/query_container_redis/query_redis_server_core.yaml
drasi wait -f examples/building_comfort/drasi/query_container_redis/query_redis_server_core.yaml -t 200
