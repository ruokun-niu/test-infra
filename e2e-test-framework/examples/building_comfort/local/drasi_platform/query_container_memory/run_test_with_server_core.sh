...
drasi apply -f examples/building_comfort/drasi/query_container_memory/query_memory_server_core.yaml
drasi wait -f examples/building_comfort/drasi/query_container_memory/query_memory_server_core.yaml -t 200
